# sessions/ â€” One brief per Claude session
...
**At start:**
1. `CLAUDE.md` (auto-loads â€” rules, accounts, infrastructure).
2. `sessions/<your-role>.md` (this directory) â€” your scope, state, open items.
3. Top of `STATUS.md` â€” what the other sessions did since you last ran.
...
1. Update your `sessions/<role>.md` â€” bump "Last session" date, log what you did, refresh open items.
...
| [coding.md](coding.md) | Coding (product + infra engineering) - the "New Coding" session is the ONE coding session; old "Coding" archived 2026-06-11 | `TODO.md`, `docs/`, `src/`, `mobile/` |
