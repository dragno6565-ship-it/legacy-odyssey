...
16. **LIFETIME / WHOLE-JOURNEY POSITIONING — NOT just a baby book, NOT just the first year (Dan, 2026-06-30, applies to EVERY session).** Legacy Odyssey is the place to record and keep a child's **entire life journey** — and it stays with them their **whole life**. It starts as a baby book (still the entry point + the SEO/ASO category term) but it KEEPS GROWING: birthdays, holidays, milestones, report cards, awards, artwork, photos, and videos — a living record of who they are as they grow up. Goal: retain each customer through age 18 and ideally past it. ALL marketing, the landing page, ad copy, captions, emails, blog, and listings must SAY or IMPLY this lifelong, keeps-growing scope — NEVER cap the value at infancy or "the first year" ("capture the first year", "baby's first months" as the whole pitch are wrong). The intro **price** is "$29 first year" (a billing fact, fine where allowed) — the **product's purpose is lifelong**. CONSTRAINTS: still respect rule #12 — convey "lasting / grows with them their whole life" WITHOUT the banned word "forever", and DON'T reach for a banned analogy (scrapbook/journal/photo album) to express the broader scope — describe it as "the place for [child]'s whole story/journey" instead. This expanded scope likely OUTGROWS the locked canonical product description (`canonical_product_description.md`) and the live landing-page copy — both are flagged for a Dan-approved rewrite.
