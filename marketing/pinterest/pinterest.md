...
- **Pins 71–100:** Images generated by `scripts/gen_pins_71_100.py`, uploaded to Supabase CDN Jun 15. Scheduling blocked — Pinterest tab must be in Chrome foreground for React to render. Full schedule table in `sessions/pinterest.md`.
...
- [ ] **Schedule pins 71–97** once Dan brings Pinterest tab to foreground (see sessions/pinterest.md for full table)
- [ ] **Schedule pins 98–100** (~Jun 18+ when 30-day window reaches Jul 16–18)
...
- **2026-06-15** — Analytics pulled. Generated + uploaded pins 71–100. Scheduling blocked by background-tab React issue. Session files fully updated.
